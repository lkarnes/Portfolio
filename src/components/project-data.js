...
import Social from '../images/social-one.png';

export const projectsData = [
    { 
        id:1,
        title:'socialone.digital',
        date:'September 2020 - current', 
        description: 'Social One is a simple way to connect with friends and share photos and stories. Inspired from apps like Facebook I have been striving to create a full sized social media app to better display my skills as a developer. This was a solo project I started from scratch on both front end and back end. I purposely avoided using any styling libraries like material-ui on this project to help me develope a better eye for design on my own. The project is still a work and progress but I am close to finishing the first release cycle, I have a lot more plans for this project in the future and hope to soon and features like direct messaging using web hooks, allowing emojis and links in text fields and setting up email verification and notifications.',
        skills: ['React', 'Redux', 'Sass', 'JsonWebToken', 'API development', 'React Portal', 'NodeJs', 'Express', 'Postgres/SQL', 'Server hosting on heroku', 'domain/ssl on namecheap', 'cloudinary for image storage', 'bcrypt', 'knex', 'helmet', 'cors'],
        img: `${Social}`,
        siteLink: 'https://socialone.digital',
        githubLink: 'https://github.com/lkarnes/social-media-website-db'    
    },
    {
        id: 2,
        title:'FindUr.city Lambda Labs', 
        date:'January-May 2020', 
        description: "Lambda Labs is The Biggest Project in Lambdas Program, spanning over 4 months it is made to simulate working on a real development team from beginning to end of a project. My group(4 developers, 2 designers and 3 data scientists) worked together to build Findur.city, an application made to help the user find the city they need based off of surveys and the DS teams custom livability score. Lambda Labs was an amazing learning experience, from learning how to speak with a stakeholder, working with UX designers and Data Scientist to writing new, clean and efficient code with a strong team of developers.",
    ...
    {   
        ...
        date:'June 2020', 
        description:'Conways Game of Life was created by the Mathmatician John Conway in the 70s originally done with pen in paper it has become a huge trend in the Computer Science community. Sadly John Conway passed away earlier this year during the Corona Virus outrbreak, to help commemorate him Lambda School assigned The Game of Life as our first CS Build Week. for this project I decided the stick with Vanilla JS rather than React or python to refresh myself on the syntax and improve my general JS ability. to display the cells on the screen I used a HTML table and assigned each position a unique id (example: r1c2 = row 2 column 3). I then created a 2d array that matches the hight and width of the table and used that to loop through and run the function to check if the cell is dead alive or born based off of conways rules. I also created some additional features like changing the timing, width, height as well as randomization, clickable cells and some prebuilt shapes that can be used. I highly encourage you to check it out if you are not familiar of Conways Game of Life its a lot of fun and pretty interesting.',
        skills: ['Vanilla JS','Algorithms','Computer Science','CSS', 'HTML Tables'],   
        img: `${Cgol}`, 
        siteLink: 'https://lkarnes.github.io/CS-Build-Week-1/index.html', 
        githubLink:'https://github.com/lkarnes/CS-Build-Week-1'
    },
    {
        id: 4,
